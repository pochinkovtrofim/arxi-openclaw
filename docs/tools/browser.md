...
- Recent-visit lookup for managed profiles, returning only page titles, URLs, and visit times. Cookie values and other browser secrets are never exposed through this action.
