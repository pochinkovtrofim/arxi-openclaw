...
| Model catalog projection                       | Retain account-scoped Codex vision, canonical effective-route normalization, model-media correlation, and one bounded catalog reread after a delayed native login notification.                                                                                                                                                                                                                                                                                                                                                                        | Upstream catalogs and delivery expose equivalent effective capabilities and provenance.                                                                                                                                 |
