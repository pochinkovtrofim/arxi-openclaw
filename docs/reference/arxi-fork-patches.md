...
| MCP resolver authority                         | Retain requester identity, authenticated host-run identity, generation fencing, and senderless background preflight. | Upstream resolver APIs carry equivalent authenticated run ownership and reject stale generations. |
