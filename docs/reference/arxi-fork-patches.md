...
| MCP resolver authority                         | Retain requester identity, authenticated host-run identity, generation fencing, and senderless account-automation resolution without replaying creator identity. | Upstream resolver APIs carry equivalent authenticated run ownership and reject stale generations. |
