...
export const MODEL_FIELD_HELP: Record<string, string> = {
  ...
  "agents.defaults.userModelFallbacks":
    "Allow explicit user session model selections to use agents.defaults.model.fallbacks for failover-worthy errors while retaining the selected model for the next turn. Default: false.",
