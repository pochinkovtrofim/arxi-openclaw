...
afterEach(() => {
  testing.setMcpServerConnectionResolversForTest(undefined);
...
describe("mcp connection resolver helpers", () => {
  it("renews short-lived headers during one long tool run and coalesces concurrent renewals", async () => {
    let now = 1_000;
