...
describe("sendMessage", () => {
  ...
  it("retains model-authored useful-result correlation for durable delivery", async () => {
    await sendMessage({
      cfg: {},
      channel: "forum",
      to: "123456",
      content: "achievement",
      runId: "run-achievement",
      replyKind: "final",
    });

    expectDeliveryCallFields({ runId: "run-achievement", replyKind: "final" });
  });
